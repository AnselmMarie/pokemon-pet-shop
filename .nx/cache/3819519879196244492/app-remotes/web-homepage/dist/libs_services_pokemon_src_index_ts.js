...
var useGetPokemonList = function() {
    ...
    return (0,_tanstack_react_query__rspack_import_0.useInfiniteQuery)({
        queryKey: queryKey,
        queryFn: queryFn,
        select: function(r) {
            return r;
...
var useGetPokemonSpecies = function(ids) {
    ...
    return (0,_tanstack_react_query__rspack_import_0.useQueries)({
        queries: (ids !== null && ids !== void 0 ? ids : []).map(function(id) {
            return {
                queryKey: [
                    'species',
                    {
